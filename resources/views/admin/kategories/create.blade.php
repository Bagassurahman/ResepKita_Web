        ...
        <div class="body">
            <div class="mb-3">
                ...
                <div class="form-group">
                    <input type="text" id="nama_kategori" name="nama_kategori" class="{{ $errors->has('nama_kategori') ? ' is-invalid' : '' }}" value="{{ old('nama_kategori') }}" required>
                </div>
            ...
            {{-- <div class="mb-3">
                ...
                <div class="form-group">
                        <input type="text" id="slug" name="slug" class="{{ $errors->has('slug') ? ' is-invalid' : '' }}" value="{{ old('slug', Auth::user()->slug) }}" required>
                </div>
                @if($errors->has('slug'))
            ...
            <div class="mb-3">
                ...
                <div class="form-group">
                    <input type="file" id="gambar_sampul" name="gambar_sampul" class="{{ $errors->has('gambar_sampul') ? ' is-invalid' : '' }}" value="{{ old('gambar_sampul') }}">
                </div>
            ...
            <div class="mb-3">
                ...
                <div class="form-group">
                    ...
                    <textarea id="summernote" name="keterangan" class="{{ $errors->has('keterangan') ? ' is-invalid' : '' }}" placeholder="Keterangan" rows="10" required></textarea>
                </div>
