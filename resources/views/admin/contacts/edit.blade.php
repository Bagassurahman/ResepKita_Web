        ...
        <div class="body">
            <div class="mb-3">
                ...
                <div class="form-group">
                    <input type="text" id="name" name="name" class="{{ $errors->has('name') ? ' is-invalid' : '' }}" value="{{ $contact->name }}" required>
                </div>
                @if($errors->has('name'))
            ...
            <div class="mb-3">
                ...
                <div class="form-group">
                    <input type="email" id="email" name="email" class="{{ $errors->has('email') ? ' is-invalid' : '' }}" value="{{ $contact->email }}" required>
                </div>
                @if($errors->has('email'))
            ...
            <div class="mb-3">
                ...
                <div class="form-group">
                    ...
                    <textarea id="summernote" class="message" name="message" class="{{ $errors->has('message') ? ' is-invalid' : '' }}" placeholder="Message" rows="10" required>{{ $contact->message }}</textarea>
                </div>
